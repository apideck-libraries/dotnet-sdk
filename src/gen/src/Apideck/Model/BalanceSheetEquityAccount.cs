...
namespace Apideck.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Balance_Sheet_Equity_Account")]
    public partial class BalanceSheetEquityAccount : IEquatable<BalanceSheetEquityAccount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BalanceSheetEquityAccount" /> class.
        /// </summary>
        /// <param name="items">A list of balance sheet accounts.</param>
        public BalanceSheetEquityAccount(List<object> items = default(List<object>))
        {
            this.Items = items;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BalanceSheetEquityAccount {\n");
        ...
        {
            return this.Equals(input as BalanceSheetEquityAccount);
        }

        /// <summary>
        /// Returns true if BalanceSheetEquityAccount instances are equal
        /// </summary>
        /// <param name="input">Instance of BalanceSheetEquityAccount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BalanceSheetEquityAccount input)
        {
            if (input == null)
            {
                return false;
