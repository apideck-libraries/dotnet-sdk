...
namespace Apideck.Model
{
    ...
    public partial class GetSharedLinkResponse : IEquatable<GetSharedLinkResponse>, IValidatableObject
    {
        ...
        public GetSharedLinkResponse(int statusCode = default(int), string status = default(string), string service = default(string), string resource = default(string), string operation = default(string), SharedLink data = default(SharedLink), Dictionary<string, Object> raw = default(Dictionary<string, Object>))
        {
