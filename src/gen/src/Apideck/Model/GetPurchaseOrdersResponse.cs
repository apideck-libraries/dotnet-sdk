...
namespace Apideck.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetPurchaseOrdersResponse")]
    public partial class GetPurchaseOrdersResponse : IEquatable<GetPurchaseOrdersResponse>, IValidatableObject
    {
        ...
        protected GetPurchaseOrdersResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetPurchaseOrdersResponse" /> class.
        /// </summary>
        ...
        public GetPurchaseOrdersResponse(int statusCode = default(int), string status = default(string), string service = default(string), string resource = default(string), string operation = default(string), List<PurchaseOrder> data = default(List<PurchaseOrder>), Meta meta = default(Meta), Links links = default(Links))
        {
            ...
            if (status == null) {
                throw new ArgumentNullException("status is a required property for GetPurchaseOrdersResponse and cannot be null");
            }
            this.Status = status;
            // to ensure "service" is required (not null)
            if (service == null) {
                throw new ArgumentNullException("service is a required property for GetPurchaseOrdersResponse and cannot be null");
            }
            this.Service = service;
            // to ensure "resource" is required (not null)
            if (resource == null) {
                throw new ArgumentNullException("resource is a required property for GetPurchaseOrdersResponse and cannot be null");
            }
            this.Resource = resource;
            // to ensure "operation" is required (not null)
            if (operation == null) {
                throw new ArgumentNullException("operation is a required property for GetPurchaseOrdersResponse and cannot be null");
            }
            this.Operation = operation;
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for GetPurchaseOrdersResponse and cannot be null");
            }
            this.Data = data;
            this.Meta = meta;
            this.Links = links;
        ...
        public List<PurchaseOrder> Data { get; set; }
