...
namespace Apideck.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AccountingDepartment")]
    public partial class AccountingDepartment : IEquatable<AccountingDepartment>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountingDepartment" /> class.
        /// </summary>
        ...
        public AccountingDepartment(string parentId = default(string), string name = default(string), StatusEnum? status = default(StatusEnum?), List<SubsidiaryReference> subsidiaries = default(List<SubsidiaryReference>), string code = default(string), string rowVersion = default(string), List<Object> passThrough = default(List<Object>))
        {
        ...
        {
            return this.Equals(input as AccountingDepartment);
        }

        /// <summary>
        /// Returns true if AccountingDepartment instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountingDepartment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountingDepartment input)
        {
            if (input == null)
            {
                return false;
