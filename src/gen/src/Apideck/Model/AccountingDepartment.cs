...
namespace Apideck.Model
{
    ...
    public partial class AccountingDepartment : IEquatable<AccountingDepartment>, IValidatableObject
    {
        ...
        public AccountingDepartment(string parentId = default(string), string name = default(string), StatusEnum? status = default(StatusEnum?), List<SubsidiaryReference> subsidiaries = default(List<SubsidiaryReference>), string rowVersion = default(string), List<Object> passThrough = default(List<Object>))
        {
