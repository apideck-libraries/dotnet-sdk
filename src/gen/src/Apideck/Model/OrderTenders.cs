...
namespace Apideck.Model
{
    ...
    public partial class OrderTenders : IEquatable<OrderTenders>, IValidatableObject
    {
        ...
        public OrderTenders(string name = default(string), TypeEnum? type = default(TypeEnum?), string note = default(string), decimal amount = default(decimal), Currency? currency = default(Currency?), decimal? totalAmount = default(decimal?), decimal? totalTip = default(decimal?), decimal? totalProcessingFee = default(decimal?), decimal? totalTax = default(decimal?), decimal? totalDiscount = default(decimal?), decimal? totalRefund = default(decimal?), decimal? totalServiceCharge = default(decimal?), decimal? buyerTenderedCashAmount = default(decimal?), decimal? changeBackCashAmount = default(decimal?), PaymentCard card = default(PaymentCard), CardStatusEnum? cardStatus = default(CardStatusEnum?), CardEntryMethodEnum? cardEntryMethod = default(CardEntryMethodEnum?))
        {
            this.Name = name;
            this.Type = type;
            this.Note = note;
