...
namespace Apideck.Model
{
    ...
    public partial class FormField : IEquatable<FormField>, IValidatableObject
    {
        ...
        public FormField(string id = default(string), string label = default(string), string placeholder = default(string), string description = default(string), TypeEnum? type = default(TypeEnum?), bool required = default(bool), bool customField = default(bool), bool allowCustomValues = false, bool? disabled = default(bool?), bool? hidden = default(bool?), bool? sensitive = default(bool?), List<FormFieldOption> options = default(List<FormFieldOption>))
        {
            this.Id = id;
            this.Label = label;
