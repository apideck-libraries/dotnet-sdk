...
namespace Apideck.Model
{
    ...
    public partial class UnauthorizedResponse : IEquatable<UnauthorizedResponse>, IValidatableObject
    {
        ...
        public UnauthorizedResponse(decimal statusCode = default(decimal), string error = default(string), string typeName = default(string), string message = default(string), object detail = default(object), string _ref = default(string))
        {
