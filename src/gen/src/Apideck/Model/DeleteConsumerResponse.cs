...
namespace Apideck.Model
{
    ...
    public partial class DeleteConsumerResponse : IEquatable<DeleteConsumerResponse>, IValidatableObject
    {
        ...
        public DeleteConsumerResponse(int statusCode = default(int), string status = default(string), Object data = default(Object), Dictionary<string, Object> raw = default(Dictionary<string, Object>))
        {
