...
namespace Apideck.Model
{
    ...
    public partial class HrisJob : IEquatable<HrisJob>, IValidatableObject
    {
        ...
        public HrisJob(string employeeId = default(string), string title = default(string), DateTime? startDate = default(DateTime?), DateTime? endDate = default(DateTime?), EmploymentStatus? employmentStatus = default(EmploymentStatus?), string department = default(string), bool? isPrimary = default(bool?), HrisJobLocation location = default(HrisJobLocation), Object customMappings = default(Object))
        {
