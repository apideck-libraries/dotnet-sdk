...
namespace Apideck.Model
{
    ...
    public partial class Webhook : IEquatable<Webhook>, IValidatableObject
    {
        ...
        public Webhook(string description = default(string), UnifiedApiId unifiedApi = default(UnifiedApiId), Status status = default(Status), string deliveryUrl = default(string), List<WebhookEventType> events = default(List<WebhookEventType>))
        {
