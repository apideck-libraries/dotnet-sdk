...
namespace Apideck.Model
{
    ...
    public partial class Expenses : IEquatable<Expenses>, IValidatableObject
    {
        ...
        public Expenses(ProfitAndLossType? type = default(ProfitAndLossType?), decimal? total = default(decimal?), List<object> records = default(List<object>))
        {
            // to ensure "total" is required (not null)
            if (total == null) {
                throw new ArgumentNullException("total is a required property for Expenses and cannot be null");
            }
            this.Total = total;
            // to ensure "records" is required (not null)
            if (records == null) {
                throw new ArgumentNullException("records is a required property for Expenses and cannot be null");
            }
        ...
        {
            return this.Equals(input as Expenses);
        }

        /// <summary>
        /// Returns true if Expenses instances are equal
        /// </summary>
        /// <param name="input">Instance of Expenses to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Expenses input)
        {
            if (input == null)
            {
                return false;
