...
namespace Apideck.Model
{
    ...
    public partial class CreateSessionResponse : IEquatable<CreateSessionResponse>, IValidatableObject
    {
        ...
        public CreateSessionResponse(int statusCode = default(int), string status = default(string), CreateSessionResponseData data = default(CreateSessionResponseData), Dictionary<string, Object> raw = default(Dictionary<string, Object>))
        {
            this.StatusCode = statusCode;
            // to ensure "status" is required (not null)
            if (status == null) {
                throw new ArgumentNullException("status is a required property for CreateSessionResponse and cannot be null");
            }
            this.Status = status;
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for CreateSessionResponse and cannot be null");
            }
            this.Data = data;
            this.Raw = raw;
        }
