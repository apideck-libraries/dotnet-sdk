...
namespace Apideck.Model
{
    ...
    public partial class GetFileResponse : IEquatable<GetFileResponse>, IValidatableObject
    {
        ...
        public GetFileResponse(int statusCode = default(int), string status = default(string), string service = default(string), string resource = default(string), string operation = default(string), UnifiedFile data = default(UnifiedFile), Dictionary<string, Object> raw = default(Dictionary<string, Object>))
        {
