...
namespace Apideck.Model
{
    ...
    public partial class GetModifiersResponse : IEquatable<GetModifiersResponse>, IValidatableObject
    {
        ...
        public GetModifiersResponse(int statusCode = default(int), string status = default(string), string service = default(string), string resource = default(string), string operation = default(string), List<Modifier> data = default(List<Modifier>), Meta meta = default(Meta), Links links = default(Links), Dictionary<string, Object> raw = default(Dictionary<string, Object>))
        {
