...
namespace Apideck.Model
{
    ...
    public partial class EcommerceProductVariants : IEquatable<EcommerceProductVariants>, IValidatableObject
    {
        ...
        public EcommerceProductVariants(string id = default(string), string name = default(string), string price = default(string), string sku = default(string), int inventoryQuantity = default(int), string weight = default(string), string weightUnit = default(string), List<EcommerceProductOptions1> options = default(List<EcommerceProductOptions1>), List<EcommerceProductImages1> images = default(List<EcommerceProductImages1>))
        {
            this.Id = id;
            this.Name = name;
            this.Price = price;
