...
namespace Apideck.Model
{
    ...
    public partial class GetCompaniesResponse : IEquatable<GetCompaniesResponse>, IValidatableObject
    {
        ...
        public GetCompaniesResponse(int statusCode = default(int), string status = default(string), string service = default(string), string resource = default(string), string operation = default(string), List<Company> data = default(List<Company>), Meta meta = default(Meta), Links links = default(Links), Dictionary<string, Object> raw = default(Dictionary<string, Object>))
        {
