...
namespace Apideck.Model
{
    ...
    public partial class CreateOrderResponse : IEquatable<CreateOrderResponse>, IValidatableObject
    {
        ...
        public CreateOrderResponse(int statusCode = default(int), string status = default(string), string service = default(string), string resource = default(string), string operation = default(string), UnifiedId data = default(UnifiedId))
        {
