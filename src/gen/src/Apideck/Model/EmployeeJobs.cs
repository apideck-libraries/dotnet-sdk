...
namespace Apideck.Model
{
    ...
    public partial class EmployeeJobs : IEquatable<EmployeeJobs>, IValidatableObject
    {
        ...
        public EmployeeJobs(string title = default(string), string role = default(string), decimal compensationRate = default(decimal), Currency? currency = default(Currency?), PaymentUnit? paymentUnit = default(PaymentUnit?), DateTime? hiredAt = default(DateTime?), bool? isPrimary = default(bool?), Address location = default(Address))
        {
            this.Title = title;
            this.Role = role;
