...
namespace Apideck.Model
{
    ...
    public partial class GetStoreResponse : IEquatable<GetStoreResponse>, IValidatableObject
    {
        ...
        public GetStoreResponse(int statusCode = default(int), string status = default(string), string service = default(string), string resource = default(string), string operation = default(string), EcommerceStore data = default(EcommerceStore))
        {
