...
namespace Apideck.Model
{
    ...
    /// PassThroughQuery
    /// </summary>
    [DataContract(Name = "PassThroughQuery")]
    public partial class PassThroughQuery : Dictionary<String, Object>, IEquatable<PassThroughQuery>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PassThroughQuery" /> class.
        /// </summary>
        ...
        public PassThroughQuery(string exampleDownstreamProperty = default(string)) : base()
        {
        ...
        {
            return this.Equals(input as PassThroughQuery);
        }

        /// <summary>
        /// Returns true if PassThroughQuery instances are equal
        /// </summary>
        /// <param name="input">Instance of PassThroughQuery to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PassThroughQuery input)
        {
            if (input == null)
            {
                return false;
