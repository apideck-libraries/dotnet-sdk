...
namespace Apideck.Model
{
    ...
    public partial class DeleteUserResponse : IEquatable<DeleteUserResponse>, IValidatableObject
    {
        ...
        public DeleteUserResponse(int statusCode = default(int), string status = default(string), string service = default(string), string resource = default(string), string operation = default(string), UnifiedId data = default(UnifiedId))
        {
