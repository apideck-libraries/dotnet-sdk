...
namespace Apideck.Model
{
    ...
    public partial class Folder : IEquatable<Folder>, IValidatableObject
    {
        ...
        public Folder(string name = default(string), string description = default(string), Owner owner = default(Owner), List<LinkedFolder> parentFolders = default(List<LinkedFolder>), Object customMappings = default(Object))
        {
