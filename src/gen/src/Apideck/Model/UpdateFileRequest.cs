...
namespace Apideck.Model
{
    ...
    public partial class UpdateFileRequest : IEquatable<UpdateFileRequest>, IValidatableObject
    {
        ...
        public UpdateFileRequest(string name = default(string), string description = default(string), string parentFolderId = default(string), List<Object> passThrough = default(List<Object>))
        {
            this.Name = name;
