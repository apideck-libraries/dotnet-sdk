...
namespace Apideck.Model
{
    ...
    public partial class GetPipelineResponse : IEquatable<GetPipelineResponse>, IValidatableObject
    {
        ...
        public GetPipelineResponse(int statusCode = default(int), string status = default(string), string service = default(string), string resource = default(string), string operation = default(string), Pipeline data = default(Pipeline), Dictionary<string, Object> raw = default(Dictionary<string, Object>))
        {
