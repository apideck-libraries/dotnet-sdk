...
namespace Apideck.Model
{
    ...
    public partial class GetPurchaseOrderResponse : IEquatable<GetPurchaseOrderResponse>, IValidatableObject
    {
        ...
        public GetPurchaseOrderResponse(int statusCode = default(int), string status = default(string), string service = default(string), string resource = default(string), string operation = default(string), PurchaseOrder data = default(PurchaseOrder))
        {
