...
namespace Apideck.Model
{
    ...
    public partial class Contact : IEquatable<Contact>, IValidatableObject
    {
        ...
        /// <param name="opportunityIds">The opportunity ids of the contact..</param>
        ...
        /// </summary>
        /// <value>The opportunity ids of the contact.</value>
        [DataMember(Name = "opportunity_ids", EmitDefaultValue = false)]
        ...
        public bool Equals(Contact input)
        {
            ...
            return 
                ...
                (
                    this.OpportunityIds == input.OpportunityIds ||
                    this.OpportunityIds != null &&
                    input.OpportunityIds != null &&
                    this.OpportunityIds.SequenceEqual(input.OpportunityIds)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.OpportunityIds.GetHashCode();
                }
