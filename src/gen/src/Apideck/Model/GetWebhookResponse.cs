...
namespace Apideck.Model
{
    ...
    public partial class GetWebhookResponse : IEquatable<GetWebhookResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public GetWebhookResponse(int statusCode = default(int), string status = default(string), Webhook data = default(Webhook), Dictionary<string, Object> raw = default(Dictionary<string, Object>))
        {
            this.StatusCode = statusCode;
            // to ensure "status" is required (not null)
            if (status == null) {
                throw new ArgumentNullException("status is a required property for GetWebhookResponse and cannot be null");
            }
            this.Status = status;
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for GetWebhookResponse and cannot be null");
            }
            this.Data = data;
            this.Raw = raw;
        }
        ...
        {
            return this.Equals(input as GetWebhookResponse);
        }

        /// <summary>
        /// Returns true if GetWebhookResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetWebhookResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetWebhookResponse input)
        {
            if (input == null)
            {
                return false;
