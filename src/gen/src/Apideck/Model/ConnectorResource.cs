...
namespace Apideck.Model
{
    ...
    public partial class ConnectorResource : IEquatable<ConnectorResource>, IValidatableObject
    {
        ...
        public ConnectorResource(string id = default(string), string name = default(string), string downstreamId = default(string), string downstreamName = default(string), ResourceStatus? status = default(ResourceStatus?), bool paginationSupported = default(bool), List<string> supportedOperations = default(List<string>), List<string> supportedFilters = default(List<string>), List<string> supportedSortBy = default(List<string>), List<ApiResourceCoverageSupportedFields> supportedFields = default(List<ApiResourceCoverageSupportedFields>), List<ApiResourceCoverageSupportedFields> supportedListFields = default(List<ApiResourceCoverageSupportedFields>))
        {
            this.Id = id;
            this.Name = name;
        ...
        public List<ApiResourceCoverageSupportedFields> SupportedListFields { get; set; }
