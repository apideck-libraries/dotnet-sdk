...
namespace Apideck.Model
{
    ...
    public partial class GetNotesResponse : IEquatable<GetNotesResponse>, IValidatableObject
    {
        ...
        public GetNotesResponse(int statusCode = default(int), string status = default(string), string service = default(string), string resource = default(string), string operation = default(string), List<Note> data = default(List<Note>), Dictionary<string, Object> raw = default(Dictionary<string, Object>), Meta meta = default(Meta), Links links = default(Links))
        {
