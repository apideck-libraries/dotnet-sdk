...
namespace Apideck.Model
{
    ...
    public partial class Modifier : IEquatable<Modifier>, IValidatableObject
    {
        ...
        public Modifier(string name = default(string), string alternateName = default(string), decimal priceAmount = default(decimal), Currency? currency = default(Currency?), string modifierGroupId = default(string), bool? available = default(bool?))
        {
