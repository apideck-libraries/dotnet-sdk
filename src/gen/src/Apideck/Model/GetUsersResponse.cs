...
namespace Apideck.Model
{
    ...
    public partial class GetUsersResponse : IEquatable<GetUsersResponse>, IValidatableObject
    {
        ...
        public GetUsersResponse(int statusCode = default(int), string status = default(string), string service = default(string), string resource = default(string), string operation = default(string), List<User> data = default(List<User>), Dictionary<string, Object> raw = default(Dictionary<string, Object>), Meta meta = default(Meta), Links links = default(Links))
        {
