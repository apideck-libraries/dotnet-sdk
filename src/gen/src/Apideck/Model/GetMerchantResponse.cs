...
namespace Apideck.Model
{
    ...
    public partial class GetMerchantResponse : IEquatable<GetMerchantResponse>, IValidatableObject
    {
        ...
        public GetMerchantResponse(int statusCode = default(int), string status = default(string), string service = default(string), string resource = default(string), string operation = default(string), Merchant data = default(Merchant))
        {
