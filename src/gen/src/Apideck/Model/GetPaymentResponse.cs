...
namespace Apideck.Model
{
    ...
    public partial class GetPaymentResponse : IEquatable<GetPaymentResponse>, IValidatableObject
    {
        ...
        public GetPaymentResponse(int statusCode = default(int), string status = default(string), string service = default(string), string resource = default(string), string operation = default(string), Payment data = default(Payment), Dictionary<string, Object> raw = default(Dictionary<string, Object>))
        {
