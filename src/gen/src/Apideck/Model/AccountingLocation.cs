...
namespace Apideck.Model
{
    ...
    public partial class AccountingLocation : IEquatable<AccountingLocation>, IValidatableObject
    {
        ...
        public AccountingLocation(string parentId = default(string), string companyName = default(string), string displayName = default(string), StatusEnum? status = default(StatusEnum?), List<Address> addresses = default(List<Address>), List<SubsidiaryReference> subsidiaries = default(List<SubsidiaryReference>), string rowVersion = default(string))
        {
