...
namespace Apideck.Model
{
    ...
    public partial class GetActivityResponse : IEquatable<GetActivityResponse>, IValidatableObject
    {
        ...
        public GetActivityResponse(int statusCode = default(int), string status = default(string), string service = default(string), string resource = default(string), string operation = default(string), Activity data = default(Activity), Dictionary<string, Object> raw = default(Dictionary<string, Object>))
        {
