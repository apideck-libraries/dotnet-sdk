...
namespace Apideck.Model
{
    ...
    public partial class GetApplicationResponse : IEquatable<GetApplicationResponse>, IValidatableObject
    {
        ...
        public GetApplicationResponse(int statusCode = default(int), string status = default(string), string service = default(string), string resource = default(string), string operation = default(string), Application data = default(Application))
        {
