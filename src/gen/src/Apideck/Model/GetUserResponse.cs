...
namespace Apideck.Model
{
    ...
    public partial class GetUserResponse : IEquatable<GetUserResponse>, IValidatableObject
    {
        ...
        public GetUserResponse(int statusCode = default(int), string status = default(string), string service = default(string), string resource = default(string), string operation = default(string), User data = default(User), Dictionary<string, Object> raw = default(Dictionary<string, Object>))
        {
