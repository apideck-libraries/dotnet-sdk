...
namespace Apideck.Model
{
    ...
    public partial class GetExpensesResponse : IEquatable<GetExpensesResponse>, IValidatableObject
    {
        ...
        public GetExpensesResponse(int statusCode = default(int), string status = default(string), string service = default(string), string resource = default(string), string operation = default(string), List<Expense> data = default(List<Expense>), Meta meta = default(Meta), Links links = default(Links), Dictionary<string, Object> raw = default(Dictionary<string, Object>))
        {
