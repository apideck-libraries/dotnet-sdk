...
namespace Apideck.Model
{
    ...
    public partial class GetLeadsResponse : IEquatable<GetLeadsResponse>, IValidatableObject
    {
        ...
        public GetLeadsResponse(int statusCode = default(int), string status = default(string), string service = default(string), string resource = default(string), string operation = default(string), List<Lead> data = default(List<Lead>), Meta meta = default(Meta), Links links = default(Links), Dictionary<string, Object> raw = default(Dictionary<string, Object>))
        {
