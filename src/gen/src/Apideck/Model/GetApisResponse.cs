...
namespace Apideck.Model
{
    ...
    public partial class GetApisResponse : IEquatable<GetApisResponse>, IValidatableObject
    {
        ...
        public GetApisResponse(int statusCode = default(int), string status = default(string), List<Api> data = default(List<Api>), Meta meta = default(Meta), Links links = default(Links))
        {
