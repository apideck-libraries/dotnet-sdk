...
namespace Apideck.Model
{
    ...
    /// GetFolderResponse
    /// </summary>
    [DataContract(Name = "GetFolderResponse")]
    public partial class GetFolderResponse : IEquatable<GetFolderResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public GetFolderResponse(int statusCode = default(int), string status = default(string), string service = default(string), string resource = default(string), string operation = default(string), Folder data = default(Folder), Dictionary<string, Object> raw = default(Dictionary<string, Object>))
        {
            this.StatusCode = statusCode;
            // to ensure "status" is required (not null)
            if (status == null) {
                throw new ArgumentNullException("status is a required property for GetFolderResponse and cannot be null");
            }
            this.Status = status;
            // to ensure "service" is required (not null)
            if (service == null) {
                throw new ArgumentNullException("service is a required property for GetFolderResponse and cannot be null");
            }
            this.Service = service;
            // to ensure "resource" is required (not null)
            if (resource == null) {
                throw new ArgumentNullException("resource is a required property for GetFolderResponse and cannot be null");
            }
            this.Resource = resource;
            // to ensure "operation" is required (not null)
            if (operation == null) {
                throw new ArgumentNullException("operation is a required property for GetFolderResponse and cannot be null");
            }
            this.Operation = operation;
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for GetFolderResponse and cannot be null");
            }
            this.Data = data;
            this.Raw = raw;
        }
        ...
        {
            return this.Equals(input as GetFolderResponse);
        }

        /// <summary>
        /// Returns true if GetFolderResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetFolderResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetFolderResponse input)
        {
            if (input == null)
            {
                return false;
