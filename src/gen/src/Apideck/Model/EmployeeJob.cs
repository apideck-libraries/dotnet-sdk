...
namespace Apideck.Model
{
    ...
    public partial class EmployeeJob : IEquatable<EmployeeJob>, IValidatableObject
    {
        ...
        public EmployeeJob(string title = default(string), string role = default(string), DateTime? startDate = default(DateTime?), DateTime? endDate = default(DateTime?), decimal? compensationRate = default(decimal?), Currency? currency = default(Currency?), PaymentUnit? paymentUnit = default(PaymentUnit?), DateTime? hiredAt = default(DateTime?), bool? isPrimary = default(bool?), bool? isManager = default(bool?), Address location = default(Address))
        {
            this.Title = title;
            this.Role = role;
