...
namespace Apideck.Model
{
    ...
    public partial class GetContactsResponse : IEquatable<GetContactsResponse>, IValidatableObject
    {
        ...
        public GetContactsResponse(int statusCode = default(int), string status = default(string), string service = default(string), string resource = default(string), string operation = default(string), List<Contact> data = default(List<Contact>), Meta meta = default(Meta), Links links = default(Links), Dictionary<string, Object> raw = default(Dictionary<string, Object>))
        {
