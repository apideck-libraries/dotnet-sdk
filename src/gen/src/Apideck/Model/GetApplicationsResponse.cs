...
namespace Apideck.Model
{
    ...
    public partial class GetApplicationsResponse : IEquatable<GetApplicationsResponse>, IValidatableObject
    {
        ...
        public GetApplicationsResponse(int statusCode = default(int), string status = default(string), string service = default(string), string resource = default(string), string operation = default(string), List<Application> data = default(List<Application>), Dictionary<string, Object> raw = default(Dictionary<string, Object>), Meta meta = default(Meta), Links links = default(Links))
        {
