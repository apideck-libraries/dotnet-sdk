...
namespace Apideck.Model
{
    ...
    public partial class HrisCompany : IEquatable<HrisCompany>, IValidatableObject
    {
        ...
        public HrisCompany(string legalName = default(string), string displayName = default(string), string subdomain = default(string), StatusEnum? status = default(StatusEnum?), string companyNumber = default(string), List<Address> addresses = default(List<Address>), List<PhoneNumber> phoneNumbers = default(List<PhoneNumber>), List<Email> emails = default(List<Email>), List<Website> websites = default(List<Website>), string debtorId = default(string))
        {
