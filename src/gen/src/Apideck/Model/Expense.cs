...
namespace Apideck.Model
{
    ...
    public partial class Expense : IEquatable<Expense>, IValidatableObject
    {
        ...
        public Expense(string number = default(string), DateTime? transactionDate = default(DateTime?), string accountId = default(string), string customerId = default(string), string supplierId = default(string), string companyId = default(string), string departmentId = default(string), Currency? currency = default(Currency?), decimal? currencyRate = default(decimal?), TypeEnum? type = default(TypeEnum?), string memo = default(string), LinkedTaxRate taxRate = default(LinkedTaxRate), decimal? totalAmount = default(decimal?), List<ExpenseLineItem> lineItems = default(List<ExpenseLineItem>), List<CustomField> customFields = default(List<CustomField>), string rowVersion = default(string), List<Object> passThrough = default(List<Object>))
        {
