...
namespace Apideck.Model
{
    ...
    public partial class Connector : IEquatable<Connector>, IValidatableObject
    {
        ...
        public Connector(string name = default(string), ConnectorStatus? status = default(ConnectorStatus?), string description = default(string), string iconUrl = default(string), string logoUrl = default(string), string websiteUrl = default(string), List<ConnectorOauthScopes> oauthScopes = default(List<ConnectorOauthScopes>), bool hasSandboxCredentials = default(bool), List<ConnectorSetting> settings = default(List<ConnectorSetting>), string serviceId = default(string), List<ConnectorUnifiedApis> unifiedApis = default(List<ConnectorUnifiedApis>), List<ConnectorSupportedResources> supportedResources = default(List<ConnectorSupportedResources>), List<string> configurableResources = default(List<string>), List<ConnectorSupportedEvents> supportedEvents = default(List<ConnectorSupportedEvents>), List<ConnectorDoc> docs = default(List<ConnectorDoc>), ConnectorTlsSupport tlsSupport = default(ConnectorTlsSupport))
        {
            this.Name = name;
            this.Status = status;
