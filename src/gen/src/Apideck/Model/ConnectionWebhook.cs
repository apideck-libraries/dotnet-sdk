...
namespace Apideck.Model
{
    ...
    public partial class ConnectionWebhook : IEquatable<ConnectionWebhook>, IValidatableObject
    {
        ...
        public ConnectionWebhook(string description = default(string), UnifiedApiId unifiedApi = default(UnifiedApiId), StatusEnum status = default(StatusEnum), string deliveryUrl = default(string), List<EventsEnum> events = default(List<EventsEnum>))
        {
