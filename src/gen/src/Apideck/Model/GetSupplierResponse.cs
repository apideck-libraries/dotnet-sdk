...
namespace Apideck.Model
{
    ...
    public partial class GetSupplierResponse : IEquatable<GetSupplierResponse>, IValidatableObject
    {
        ...
        public GetSupplierResponse(int statusCode = default(int), string status = default(string), string service = default(string), string resource = default(string), string operation = default(string), Supplier data = default(Supplier))
        {
