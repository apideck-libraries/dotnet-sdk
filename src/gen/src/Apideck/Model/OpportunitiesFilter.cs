...
namespace Apideck.Model
{
    ...
    public partial class OpportunitiesFilter : IEquatable<OpportunitiesFilter>, IValidatableObject
    {
        ...
        public OpportunitiesFilter(string title = default(string), string status = default(string), decimal monetaryAmount = default(decimal), decimal winProbability = default(decimal), string companyId = default(string))
        {
            this.Title = title;
            this.Status = status;
