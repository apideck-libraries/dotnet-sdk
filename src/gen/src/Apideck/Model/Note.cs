...
namespace Apideck.Model
{
    ...
    public partial class Note : IEquatable<Note>, IValidatableObject
    {
        ...
        /// <param name="activityId">The activity that is related to the note..</param>
        ...
        public Note(string title = default(string), string content = default(string), string ownerId = default(string), string contactId = default(string), string companyId = default(string), string opportunityId = default(string), string activityId = default(string), string leadId = default(string), bool? active = default(bool?), List<Object> passThrough = default(List<Object>))
        {
            this.Title = title;
        ...
        /// </summary>
        /// <value>The activity that is related to the note.</value>
