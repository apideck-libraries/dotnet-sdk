...
namespace Apideck.Model
{
    ...
    public partial class GetFilesResponse : IEquatable<GetFilesResponse>, IValidatableObject
    {
        ...
        public GetFilesResponse(int statusCode = default(int), string status = default(string), string service = default(string), string resource = default(string), string operation = default(string), List<UnifiedFile> data = default(List<UnifiedFile>), Meta meta = default(Meta), Links links = default(Links), Dictionary<string, Object> raw = default(Dictionary<string, Object>))
        {
