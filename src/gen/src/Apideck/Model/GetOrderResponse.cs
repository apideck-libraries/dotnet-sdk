...
namespace Apideck.Model
{
    ...
    public partial class GetOrderResponse : IEquatable<GetOrderResponse>, IValidatableObject
    {
        ...
        public GetOrderResponse(int statusCode = default(int), string status = default(string), string service = default(string), string resource = default(string), string operation = default(string), Order data = default(Order), Dictionary<string, Object> raw = default(Dictionary<string, Object>))
        {
