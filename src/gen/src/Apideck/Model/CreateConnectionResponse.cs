...
namespace Apideck.Model
{
    ...
    public partial class CreateConnectionResponse : IEquatable<CreateConnectionResponse>, IValidatableObject
    {
        ...
        public CreateConnectionResponse(int statusCode = default(int), string status = default(string), Connection data = default(Connection), Dictionary<string, Object> raw = default(Dictionary<string, Object>))
        {
