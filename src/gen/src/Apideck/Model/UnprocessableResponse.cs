...
namespace Apideck.Model
{
    ...
    public partial class UnprocessableResponse : IEquatable<UnprocessableResponse>, IValidatableObject
    {
        ...
        public UnprocessableResponse(decimal statusCode = default(decimal), string error = default(string), string typeName = default(string), string message = default(string), object detail = default(object), string _ref = default(string))
        {
