...
namespace Apideck.Model
{
    ...
    public partial class GetMessagesResponse : IEquatable<GetMessagesResponse>, IValidatableObject
    {
        ...
        public GetMessagesResponse(int statusCode = default(int), string status = default(string), string service = default(string), string resource = default(string), string operation = default(string), List<Message> data = default(List<Message>), Dictionary<string, Object> raw = default(Dictionary<string, Object>), Meta meta = default(Meta), Links links = default(Links))
        {
