...
namespace Apideck.Model
{
    ...
    public partial class Location : IEquatable<Location>, IValidatableObject
    {
        ...
        public Location(string name = default(string), string businessName = default(string), Address address = default(Address), StatusEnum? status = default(StatusEnum?), string merchantId = default(string), Currency? currency = default(Currency?), Object customMappings = default(Object))
        {
            this.Name = name;
