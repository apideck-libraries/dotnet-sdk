...
namespace Apideck.Model
{
    ...
    public partial class CreateSupplierResponse : IEquatable<CreateSupplierResponse>, IValidatableObject
    {
        ...
        protected CreateSupplierResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSupplierResponse" /> class.
        /// </summary>
        ...
        public CreateSupplierResponse(int statusCode = default(int), string status = default(string), string service = default(string), string resource = default(string), string operation = default(string), UnifiedId data = default(UnifiedId))
        {
            ...
            if (status == null) {
                throw new ArgumentNullException("status is a required property for CreateSupplierResponse and cannot be null");
            }
            this.Status = status;
            // to ensure "service" is required (not null)
            if (service == null) {
                throw new ArgumentNullException("service is a required property for CreateSupplierResponse and cannot be null");
            }
            this.Service = service;
            // to ensure "resource" is required (not null)
            if (resource == null) {
                throw new ArgumentNullException("resource is a required property for CreateSupplierResponse and cannot be null");
            }
            this.Resource = resource;
            // to ensure "operation" is required (not null)
            if (operation == null) {
                throw new ArgumentNullException("operation is a required property for CreateSupplierResponse and cannot be null");
            }
