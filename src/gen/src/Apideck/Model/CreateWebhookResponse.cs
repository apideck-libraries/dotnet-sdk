...
namespace Apideck.Model
{
    ...
    public partial class CreateWebhookResponse : IEquatable<CreateWebhookResponse>, IValidatableObject
    {
        ...
        public CreateWebhookResponse(int statusCode = default(int), string status = default(string), Webhook data = default(Webhook), Dictionary<string, Object> raw = default(Dictionary<string, Object>))
        {
