...
namespace Apideck.Model
{
    ...
    public partial class InvoiceItem : IEquatable<InvoiceItem>, IValidatableObject
    {
        ...
        public enum TypeEnum
        {
            ...
            /// <summary>
            /// Enum NonInventory for value: non_inventory
            /// </summary>
        ...
        /// <param name="taxable">If true, transactions for this item are taxable.</param>
        ...
        /// <param name="subsidiaryId">The ID of the subsidiary.</param>
        /// <param name="taxScheduleId">The ID of the tax schedule.</param>
        ...
        /// </summary>
        /// <value>If true, transactions for this item are taxable</value>
        ...
        /// </summary>
        /// <value>The ID of the subsidiary</value>
        [DataMember(Name = "subsidiary_id", EmitDefaultValue = true)]
        public string SubsidiaryId { get; set; }

        /// <summary>
        /// The ID of the tax schedule
        /// </summary>
        /// <value>The ID of the tax schedule</value>
        [DataMember(Name = "tax_schedule_id", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SubsidiaryId: ").Append(SubsidiaryId).Append("\n");
            sb.Append("  TaxScheduleId: ").Append(TaxScheduleId).Append("\n");
        ...
        public bool Equals(InvoiceItem input)
        {
            ...
            return 
                ...
                (
                    this.SubsidiaryId == input.SubsidiaryId ||
                    (this.SubsidiaryId != null &&
                    this.SubsidiaryId.Equals(input.SubsidiaryId))
                ) && 
                (
                    this.TaxScheduleId == input.TaxScheduleId ||
                    (this.TaxScheduleId != null &&
                    this.TaxScheduleId.Equals(input.TaxScheduleId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.SubsidiaryId.GetHashCode();
                }
                if (this.TaxScheduleId != null)
                {
                    hashCode = (hashCode * 59) + this.TaxScheduleId.GetHashCode();
                }
