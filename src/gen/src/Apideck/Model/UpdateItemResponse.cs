...
namespace Apideck.Model
{
    ...
    public partial class UpdateItemResponse : IEquatable<UpdateItemResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public UpdateItemResponse(int statusCode = default(int), string status = default(string), string service = default(string), string resource = default(string), string operation = default(string), UnifiedId data = default(UnifiedId), Dictionary<string, Object> raw = default(Dictionary<string, Object>))
        {
            this.StatusCode = statusCode;
            // to ensure "status" is required (not null)
            if (status == null) {
                throw new ArgumentNullException("status is a required property for UpdateItemResponse and cannot be null");
            }
            this.Status = status;
            // to ensure "service" is required (not null)
            if (service == null) {
                throw new ArgumentNullException("service is a required property for UpdateItemResponse and cannot be null");
            }
            this.Service = service;
            // to ensure "resource" is required (not null)
            if (resource == null) {
                throw new ArgumentNullException("resource is a required property for UpdateItemResponse and cannot be null");
            }
            this.Resource = resource;
            // to ensure "operation" is required (not null)
            if (operation == null) {
                throw new ArgumentNullException("operation is a required property for UpdateItemResponse and cannot be null");
            }
            this.Operation = operation;
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for UpdateItemResponse and cannot be null");
            }
            this.Data = data;
            this.Raw = raw;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateItemResponse {\n");
        ...
        {
            return this.Equals(input as UpdateItemResponse);
        }

        /// <summary>
        /// Returns true if UpdateItemResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateItemResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateItemResponse input)
        {
            if (input == null)
            {
                return false;
