...
namespace Apideck.Model
{
    ...
    public partial class Tender : IEquatable<Tender>, IValidatableObject
    {
        ...
        public Tender(string key = default(string), string label = default(string), bool? active = default(bool?), bool? hidden = default(bool?), bool? editable = default(bool?), bool opensCashDrawer = true, bool allowsTipping = true, List<Object> passThrough = default(List<Object>))
        {
            this.Key = key;
            this.Label = label;
            this.Active = active;
