...
namespace Apideck.Model
{
    ...
    public partial class GetBillsResponse : IEquatable<GetBillsResponse>, IValidatableObject
    {
        ...
        public GetBillsResponse(int statusCode = default(int), string status = default(string), string service = default(string), string resource = default(string), string operation = default(string), List<Bill> data = default(List<Bill>), Meta meta = default(Meta), Links links = default(Links), Dictionary<string, Object> raw = default(Dictionary<string, Object>))
        {
