...
namespace Apideck.Model
{
    ...
    public partial class ApiResourceCoverageCoverage : IEquatable<ApiResourceCoverageCoverage>, IValidatableObject
    {
        ...
        public ApiResourceCoverageCoverage(string downstreamId = default(string), string downstreamName = default(string), bool paginationSupported = default(bool), List<string> supportedOperations = default(List<string>), List<string> supportedFilters = default(List<string>), List<string> supportedSortBy = default(List<string>), List<ApiResourceCoverageSupportedFields> supportedFields = default(List<ApiResourceCoverageSupportedFields>), List<ApiResourceCoverageSupportedFields> supportedListFields = default(List<ApiResourceCoverageSupportedFields>))
        {
