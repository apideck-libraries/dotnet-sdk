...
namespace Apideck.Model
{
    ...
    /// UpdateOrderResponse
    /// </summary>
    [DataContract(Name = "UpdateOrderResponse")]
    public partial class UpdateOrderResponse : IEquatable<UpdateOrderResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateOrderResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateOrderResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateOrderResponse" /> class.
        /// </summary>
        ...
        public UpdateOrderResponse(int statusCode = default(int), string status = default(string), string service = default(string), string resource = default(string), string operation = default(string), UnifiedId data = default(UnifiedId), Dictionary<string, Object> raw = default(Dictionary<string, Object>))
        {
            this.StatusCode = statusCode;
            // to ensure "status" is required (not null)
            if (status == null) {
                throw new ArgumentNullException("status is a required property for UpdateOrderResponse and cannot be null");
            }
            this.Status = status;
            // to ensure "service" is required (not null)
            if (service == null) {
                throw new ArgumentNullException("service is a required property for UpdateOrderResponse and cannot be null");
            }
            this.Service = service;
            // to ensure "resource" is required (not null)
            if (resource == null) {
                throw new ArgumentNullException("resource is a required property for UpdateOrderResponse and cannot be null");
            }
            this.Resource = resource;
            // to ensure "operation" is required (not null)
            if (operation == null) {
                throw new ArgumentNullException("operation is a required property for UpdateOrderResponse and cannot be null");
            }
            this.Operation = operation;
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for UpdateOrderResponse and cannot be null");
            }
            this.Data = data;
            this.Raw = raw;
        }
        ...
        /// <summary>
        /// Returns true if UpdateOrderResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateOrderResponse to be compared</param>
        /// <returns>Boolean</returns>
