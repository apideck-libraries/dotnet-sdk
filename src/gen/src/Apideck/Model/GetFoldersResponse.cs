...
namespace Apideck.Model
{
    ...
    public partial class GetFoldersResponse : IEquatable<GetFoldersResponse>, IValidatableObject
    {
        ...
        public GetFoldersResponse(int statusCode = default(int), string status = default(string), string service = default(string), string resource = default(string), string operation = default(string), List<Folder> data = default(List<Folder>), Meta meta = default(Meta), Links links = default(Links), Dictionary<string, Object> raw = default(Dictionary<string, Object>))
        {
