...
namespace Apideck.Model
{
    ...
    public partial class Subsidiary : IEquatable<Subsidiary>, IValidatableObject
    {
        ...
        public Subsidiary(string parentId = default(string), string name = default(string), StatusEnum? status = default(StatusEnum?), string rowVersion = default(string), List<Object> passThrough = default(List<Object>))
        {
