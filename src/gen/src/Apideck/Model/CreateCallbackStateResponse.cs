...
namespace Apideck.Model
{
    ...
    public partial class CreateCallbackStateResponse : IEquatable<CreateCallbackStateResponse>, IValidatableObject
    {
        ...
        public CreateCallbackStateResponse(int statusCode = default(int), string status = default(string), CreateCallbackStateResponseData data = default(CreateCallbackStateResponseData), Dictionary<string, Object> raw = default(Dictionary<string, Object>))
        {
