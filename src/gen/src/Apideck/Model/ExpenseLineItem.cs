...
namespace Apideck.Model
{
    ...
    public partial class ExpenseLineItem : IEquatable<ExpenseLineItem>, IValidatableObject
    {
        ...
        public ExpenseLineItem(List<LinkedTrackingCategory> trackingCategories = default(List<LinkedTrackingCategory>), string accountId = default(string), string customerId = default(string), string departmentId = default(string), string locationId = default(string), string subsidiaryId = default(string), LinkedTaxRate taxRate = default(LinkedTaxRate), string description = default(string), decimal? totalAmount = default(decimal?), bool billable = default(bool), int? lineNumber = default(int?))
        {
