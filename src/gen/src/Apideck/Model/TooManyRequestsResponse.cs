...
namespace Apideck.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TooManyRequestsResponse")]
    public partial class TooManyRequestsResponse : IEquatable<TooManyRequestsResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TooManyRequestsResponse" /> class.
        /// </summary>
        /// <param name="statusCode">HTTP status code.</param>
        /// <param name="error">Contains an explanation of the status_code as defined in HTTP/1.1 standard (RFC 6585).</param>
        ...
        public TooManyRequestsResponse(decimal statusCode = default(decimal), string error = default(string), string typeName = default(string), string message = default(string), TooManyRequestsResponseDetail detail = default(TooManyRequestsResponseDetail), string _ref = default(string))
        {
        ...
        /// </summary>
        /// <value>Contains an explanation of the status_code as defined in HTTP/1.1 standard (RFC 6585)</value>
        ...
        {
            return this.Equals(input as TooManyRequestsResponse);
        }
