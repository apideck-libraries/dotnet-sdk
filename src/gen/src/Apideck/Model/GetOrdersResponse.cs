...
namespace Apideck.Model
{
    ...
    public partial class GetOrdersResponse : IEquatable<GetOrdersResponse>, IValidatableObject
    {
        ...
        public GetOrdersResponse(int statusCode = default(int), string status = default(string), string service = default(string), string resource = default(string), string operation = default(string), List<Order> data = default(List<Order>), Meta meta = default(Meta), Links links = default(Links), Dictionary<string, Object> raw = default(Dictionary<string, Object>))
        {
