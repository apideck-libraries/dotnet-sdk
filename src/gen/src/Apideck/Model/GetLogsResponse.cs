...
namespace Apideck.Model
{
    ...
    public partial class GetLogsResponse : IEquatable<GetLogsResponse>, IValidatableObject
    {
        ...
        public GetLogsResponse(int statusCode = default(int), string status = default(string), List<Log> data = default(List<Log>), Meta meta = default(Meta), Links links = default(Links))
        {
            ...
            if (status == null) {
                throw new ArgumentNullException("status is a required property for GetLogsResponse and cannot be null");
            }
            this.Status = status;
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for GetLogsResponse and cannot be null");
            }
            this.Data = data;
            this.Meta = meta;
            this.Links = links;
