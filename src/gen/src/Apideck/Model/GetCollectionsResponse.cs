...
namespace Apideck.Model
{
    ...
    public partial class GetCollectionsResponse : IEquatable<GetCollectionsResponse>, IValidatableObject
    {
        ...
        public GetCollectionsResponse(int statusCode = default(int), string status = default(string), string service = default(string), string resource = default(string), string operation = default(string), List<Collection> data = default(List<Collection>), Meta meta = default(Meta), Links links = default(Links), Dictionary<string, Object> raw = default(Dictionary<string, Object>))
        {
