...
namespace Apideck.Model
{
    ...
    public partial class GetInvoiceResponse : IEquatable<GetInvoiceResponse>, IValidatableObject
    {
        ...
        public GetInvoiceResponse(int statusCode = default(int), string status = default(string), string service = default(string), string resource = default(string), string operation = default(string), Invoice data = default(Invoice))
        {
