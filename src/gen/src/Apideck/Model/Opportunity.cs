...
namespace Apideck.Model
{
    ...
    public partial class Opportunity : IEquatable<Opportunity>, IValidatableObject
    {
        ...
        /// <param name="primaryContactId">The unique identifier of the primary contact associated with the opportunity..</param>
        ...
        [DataMember(Name = "primary_contact_id", EmitDefaultValue = true)]
