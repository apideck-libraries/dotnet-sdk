...
namespace Apideck.Model
{
    ...
    public partial class DeletePipelineResponse : IEquatable<DeletePipelineResponse>, IValidatableObject
    {
        ...
        public DeletePipelineResponse(int statusCode = default(int), string status = default(string), string service = default(string), string resource = default(string), string operation = default(string), UnifiedId data = default(UnifiedId), Dictionary<string, Object> raw = default(Dictionary<string, Object>))
        {
