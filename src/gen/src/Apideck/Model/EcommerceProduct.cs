...
namespace Apideck.Model
{
    ...
    public partial class EcommerceProduct : IEquatable<EcommerceProduct>, IValidatableObject
    {
        ...
        public EcommerceProduct(string name = default(string), string description = default(string), StatusEnum? status = default(StatusEnum?), string price = default(string), string sku = default(string), int inventoryQuantity = default(int), List<EcommerceProductImages> images = default(List<EcommerceProductImages>), string weight = default(string), string weightUnit = default(string), List<EcommerceProductOptions> options = default(List<EcommerceProductOptions>), List<EcommerceProductVariants> variants = default(List<EcommerceProductVariants>), List<string> tags = default(List<string>), List<string> categories = default(List<string>))
        {
            this.Name = name;
