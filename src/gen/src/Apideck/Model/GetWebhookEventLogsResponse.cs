...
namespace Apideck.Model
{
    ...
    public partial class GetWebhookEventLogsResponse : IEquatable<GetWebhookEventLogsResponse>, IValidatableObject
    {
        ...
        public GetWebhookEventLogsResponse(int statusCode = default(int), string status = default(string), List<WebhookEventLog> data = default(List<WebhookEventLog>), Meta meta = default(Meta), Links links = default(Links))
        {
