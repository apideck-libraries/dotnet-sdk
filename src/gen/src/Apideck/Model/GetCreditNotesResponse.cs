...
namespace Apideck.Model
{
    ...
    public partial class GetCreditNotesResponse : IEquatable<GetCreditNotesResponse>, IValidatableObject
    {
        ...
        public GetCreditNotesResponse(int statusCode = default(int), string status = default(string), string service = default(string), string resource = default(string), string operation = default(string), List<CreditNote> data = default(List<CreditNote>), Meta meta = default(Meta), Links links = default(Links), Dictionary<string, Object> raw = default(Dictionary<string, Object>))
        {
