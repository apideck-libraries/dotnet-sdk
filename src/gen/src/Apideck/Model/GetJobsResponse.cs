...
namespace Apideck.Model
{
    ...
    public partial class GetJobsResponse : IEquatable<GetJobsResponse>, IValidatableObject
    {
        ...
        public GetJobsResponse(int statusCode = default(int), string status = default(string), string service = default(string), string resource = default(string), string operation = default(string), List<Job> data = default(List<Job>), Dictionary<string, Object> raw = default(Dictionary<string, Object>), Meta meta = default(Meta), Links links = default(Links))
        {
