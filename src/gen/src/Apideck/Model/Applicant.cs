...
namespace Apideck.Model
{
    ...
    public partial class Applicant : IEquatable<Applicant>, IValidatableObject
    {
        ...
        public Applicant(string positionId = default(string), string name = default(string), string firstName = default(string), string lastName = default(string), string middleName = default(string), string initials = default(string), DateTime? birthday = default(DateTime?), string photoUrl = default(string), string headline = default(string), string title = default(string), List<Email> emails = default(List<Email>), List<PhoneNumber> phoneNumbers = default(List<PhoneNumber>), List<Address> addresses = default(List<Address>), List<ApplicantWebsites> websites = default(List<ApplicantWebsites>), List<string> applications = default(List<string>), List<string> followers = default(List<string>), List<string> sources = default(List<string>), bool confidential = default(bool), bool anonymized = default(bool), List<string> tags = default(List<string>), bool archived = default(bool), string ownerId = default(string), string recordUrl = default(string), bool? deleted = default(bool?))
        {
        ...
        /// <summary>
        /// Returns false as RecruiterId should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeRecruiterId()
        {
            return false;
        }
        /// <summary>
        ...
        /// <summary>
        /// Returns false as CoordinatorId should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeCoordinatorId()
        {
            return false;
        }
        /// <summary>
