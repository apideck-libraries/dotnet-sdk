...
namespace Apideck.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PaymentRequiredResponse")]
    public partial class PaymentRequiredResponse : IEquatable<PaymentRequiredResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public PaymentRequiredResponse(decimal statusCode = default(decimal), string error = default(string), string typeName = default(string), string message = default(string), string detail = default(string), string _ref = default(string))
        {
        ...
        {
            return this.Equals(input as PaymentRequiredResponse);
        }

        /// <summary>
        /// Returns true if PaymentRequiredResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentRequiredResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentRequiredResponse input)
        {
            if (input == null)
            {
                return false;
