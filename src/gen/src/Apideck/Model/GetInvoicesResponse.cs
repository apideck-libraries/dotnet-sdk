...
namespace Apideck.Model
{
    ...
    public partial class GetInvoicesResponse : IEquatable<GetInvoicesResponse>, IValidatableObject
    {
        ...
        public GetInvoicesResponse(int statusCode = default(int), string status = default(string), string service = default(string), string resource = default(string), string operation = default(string), List<Invoice> data = default(List<Invoice>), Meta meta = default(Meta), Links links = default(Links), Dictionary<string, Object> raw = default(Dictionary<string, Object>))
        {
