...
namespace Apideck.Model
{
    ...
    public partial class BillLineItem : IEquatable<BillLineItem>, IValidatableObject
    {
        ...
        public BillLineItem(string rowId = default(string), string code = default(string), int? lineNumber = default(int?), string description = default(string), TypeEnum? type = default(TypeEnum?), decimal? taxAmount = default(decimal?), decimal? totalAmount = default(decimal?), decimal? quantity = default(decimal?), decimal? unitPrice = default(decimal?), string unitOfMeasure = default(string), decimal? discountPercentage = default(decimal?), string locationId = default(string), string departmentId = default(string), LinkedInvoiceItem item = default(LinkedInvoiceItem), LinkedLedgerAccount ledgerAccount = default(LinkedLedgerAccount), LinkedTaxRate taxRate = default(LinkedTaxRate), string rowVersion = default(string))
        {
            this.RowId = rowId;
            this.Code = code;
