...
namespace Apideck.Model
{
    ...
    public partial class SessionTheme : IEquatable<SessionTheme>, IValidatableObject
    {
        ...
        /// <param name="privacyUrl">privacyUrl.</param>
        /// <param name="sidepanelBackgroundColor">sidepanelBackgroundColor.</param>
        /// <param name="sidepanelTextColor">sidepanelTextColor.</param>
        /// <param name="termsUrl">termsUrl.</param>
        /// <param name="vaultName">vaultName.</param>
        public SessionTheme(string favicon = default(string), string primaryColor = default(string), string privacyUrl = default(string), string sidepanelBackgroundColor = default(string), string sidepanelTextColor = default(string), string termsUrl = default(string), string vaultName = default(string))
        {
