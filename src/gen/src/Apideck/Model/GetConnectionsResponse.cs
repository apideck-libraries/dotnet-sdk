...
namespace Apideck.Model
{
    ...
    public partial class GetConnectionsResponse : IEquatable<GetConnectionsResponse>, IValidatableObject
    {
        ...
        public GetConnectionsResponse(int statusCode = default(int), string status = default(string), List<Connection> data = default(List<Connection>), Dictionary<string, Object> raw = default(Dictionary<string, Object>))
        {
