...
namespace Apideck.Model
{
    ...
    public partial class GetProductsResponse : IEquatable<GetProductsResponse>, IValidatableObject
    {
        ...
        public GetProductsResponse(int statusCode = default(int), string status = default(string), string service = default(string), string resource = default(string), string operation = default(string), List<EcommerceProduct> data = default(List<EcommerceProduct>), Dictionary<string, Object> raw = default(Dictionary<string, Object>), Meta meta = default(Meta), Links links = default(Links))
        {
