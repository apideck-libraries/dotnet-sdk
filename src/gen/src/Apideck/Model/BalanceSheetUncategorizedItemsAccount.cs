...
namespace Apideck.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Balance_Sheet_Uncategorized_Items_Account")]
    public partial class BalanceSheetUncategorizedItemsAccount : IEquatable<BalanceSheetUncategorizedItemsAccount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BalanceSheetUncategorizedItemsAccount" /> class.
        /// </summary>
        /// <param name="items">A list of balance sheet accounts.</param>
        public BalanceSheetUncategorizedItemsAccount(List<object> items = default(List<object>))
        {
            this.Items = items;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BalanceSheetUncategorizedItemsAccount {\n");
        ...
        {
            return this.Equals(input as BalanceSheetUncategorizedItemsAccount);
        }

        /// <summary>
        /// Returns true if BalanceSheetUncategorizedItemsAccount instances are equal
        /// </summary>
        /// <param name="input">Instance of BalanceSheetUncategorizedItemsAccount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BalanceSheetUncategorizedItemsAccount input)
        {
            if (input == null)
            {
                return false;
