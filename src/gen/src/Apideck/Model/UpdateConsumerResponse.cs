...
namespace Apideck.Model
{
    ...
    public partial class UpdateConsumerResponse : IEquatable<UpdateConsumerResponse>, IValidatableObject
    {
        ...
        public UpdateConsumerResponse(int statusCode = default(int), string status = default(string), Consumer data = default(Consumer), Dictionary<string, Object> raw = default(Dictionary<string, Object>))
        {
