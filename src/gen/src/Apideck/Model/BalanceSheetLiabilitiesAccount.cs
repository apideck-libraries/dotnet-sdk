...
namespace Apideck.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Balance_Sheet_Liabilities_Account")]
    public partial class BalanceSheetLiabilitiesAccount : IEquatable<BalanceSheetLiabilitiesAccount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BalanceSheetLiabilitiesAccount" /> class.
        /// </summary>
        /// <param name="items">A list of balance sheet accounts.</param>
        public BalanceSheetLiabilitiesAccount(List<object> items = default(List<object>))
        {
            this.Items = items;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BalanceSheetLiabilitiesAccount {\n");
        ...
        {
            return this.Equals(input as BalanceSheetLiabilitiesAccount);
        }

        /// <summary>
        /// Returns true if BalanceSheetLiabilitiesAccount instances are equal
        /// </summary>
        /// <param name="input">Instance of BalanceSheetLiabilitiesAccount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BalanceSheetLiabilitiesAccount input)
        {
            if (input == null)
            {
                return false;
