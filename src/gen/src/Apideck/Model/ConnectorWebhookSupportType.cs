...
namespace Apideck.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Connector_webhook_support_type")]
    public partial class ConnectorWebhookSupportType : IEquatable<ConnectorWebhookSupportType>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ConnectorWebhookSupportType" /> class.
        /// </summary>
        ...
        public ConnectorWebhookSupportType(ModeEnum? mode = default(ModeEnum?), SubscriptionLevelEnum? subscriptionLevel = default(SubscriptionLevelEnum?), ManagedViaEnum? managedVia = default(ManagedViaEnum?))
        {
            this.Mode = mode;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ConnectorWebhookSupportType {\n");
        ...
        {
            return this.Equals(input as ConnectorWebhookSupportType);
        }

        /// <summary>
        /// Returns true if ConnectorWebhookSupportType instances are equal
        /// </summary>
        /// <param name="input">Instance of ConnectorWebhookSupportType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConnectorWebhookSupportType input)
        {
            if (input == null)
            {
                return false;
