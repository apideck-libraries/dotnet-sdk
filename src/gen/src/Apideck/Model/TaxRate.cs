...
namespace Apideck.Model
{
    ...
    public partial class TaxRate : IEquatable<TaxRate>, IValidatableObject
    {
        ...
        public TaxRate(string id = default(string), string name = default(string), string code = default(string), string description = default(string), decimal? effectiveTaxRate = default(decimal?), decimal? totalTaxRate = default(decimal?), string taxPayableAccountId = default(string), string taxRemittedAccountId = default(string), List<Object> components = default(List<Object>), string type = default(string), string reportTaxType = default(string), string originalTaxRateId = default(string), StatusEnum? status = default(StatusEnum?), string rowVersion = default(string), List<Object> passThrough = default(List<Object>))
        {
            this.Id = id;
            this.Name = name;
            this.Code = code;
