...
namespace Apideck.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DeprecatedLinkedSupplier")]
    public partial class DeprecatedLinkedSupplier : IEquatable<DeprecatedLinkedSupplier>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeprecatedLinkedSupplier" /> class.
        /// </summary>
        /// <param name="displayName">The display name of the supplier..</param>
        /// <param name="address">address.</param>
        public DeprecatedLinkedSupplier(string displayName = default(string), Address address = default(Address))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeprecatedLinkedSupplier {\n");
        ...
        {
            return this.Equals(input as DeprecatedLinkedSupplier);
        }

        /// <summary>
        /// Returns true if DeprecatedLinkedSupplier instances are equal
        /// </summary>
        /// <param name="input">Instance of DeprecatedLinkedSupplier to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeprecatedLinkedSupplier input)
        {
            if (input == null)
            {
                return false;
