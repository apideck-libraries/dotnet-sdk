...
namespace Apideck.Model
{
    ...
    public partial class TimeOffRequestsFilter : IEquatable<TimeOffRequestsFilter>, IValidatableObject
    {
        ...
        public TimeOffRequestsFilter(string startDate = default(string), string endDate = default(string), string employeeId = default(string), TimeOffRequestStatusEnum? timeOffRequestStatus = default(TimeOffRequestStatusEnum?))
        {
