...
namespace Apideck.Api
{
    ...
    public interface IConnectorApiSync : IApiAccessor
    {
        ...
        /// <param name="resourceId">ID of the resource you are acting upon.</param>
        /// <param name="appId">The ID of your Unify application (optional)</param>
        /// <param name="unifiedApi">Specify unified API for the connector resource. This is useful when a resource appears in multiple APIs (optional)</param>
        /// <returns>GetConnectorResourceResponse</returns>
        GetConnectorResourceResponse ConnectorResourcesOne(string id, string resourceId, string appId = default(string), UnifiedApiId? unifiedApi = default(UnifiedApiId?));
        ...
        ApiResponse<GetConnectorResourceResponse> ConnectorResourcesOneWithHttpInfo(string id, string resourceId, string appId = default(string), UnifiedApiId? unifiedApi = default(UnifiedApiId?));
        /// <summary>
        /// List Connectors
        /// </summary>
        /// <remarks>
    ...
    public interface IConnectorApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<GetConnectorResourceResponse> ConnectorResourcesOneAsync(string id, string resourceId, string appId = default(string), UnifiedApiId? unifiedApi = default(UnifiedApiId?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<GetConnectorResourceResponse>> ConnectorResourcesOneWithHttpInfoAsync(string id, string resourceId, string appId = default(string), UnifiedApiId? unifiedApi = default(UnifiedApiId?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// List Connectors
        /// </summary>
        /// <remarks>
    ...
    public partial class ConnectorApi : IConnectorApi
    {
        ...
        /// <param name="unifiedApi">Specify unified API for the connector resource. This is useful when a resource appears in multiple APIs (optional)</param>
        /// <returns>GetConnectorResourceResponse</returns>
        public GetConnectorResourceResponse ConnectorResourcesOne(string id, string resourceId, string appId = default(string), UnifiedApiId? unifiedApi = default(UnifiedApiId?))
        {
            Apideck.Client.ApiResponse<GetConnectorResourceResponse> localVarResponse = ConnectorResourcesOneWithHttpInfo(id, resourceId, appId, unifiedApi);
            return localVarResponse.Data;
        }
        ...
        /// <param name="unifiedApi">Specify unified API for the connector resource. This is useful when a resource appears in multiple APIs (optional)</param>
        /// <returns>ApiResponse of GetConnectorResourceResponse</returns>
        public Apideck.Client.ApiResponse<GetConnectorResourceResponse> ConnectorResourcesOneWithHttpInfo(string id, string resourceId, string appId = default(string), UnifiedApiId? unifiedApi = default(UnifiedApiId?))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
            ...
            if (unifiedApi != null)
            {
                localVarRequestOptions.QueryParameters.Add(Apideck.Client.ClientUtils.ParameterToMultiMap("", "unified_api", unifiedApi));
            }
            if (appId != null)
            {
                localVarRequestOptions.HeaderParameters.Add("x-apideck-app-id", Apideck.Client.ClientUtils.ParameterToString(appId)); // header parameter
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of GetConnectorResourceResponse</returns>
        public async System.Threading.Tasks.Task<GetConnectorResourceResponse> ConnectorResourcesOneAsync(string id, string resourceId, string appId = default(string), UnifiedApiId? unifiedApi = default(UnifiedApiId?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Apideck.Client.ApiResponse<GetConnectorResourceResponse> localVarResponse = await ConnectorResourcesOneWithHttpInfoAsync(id, resourceId, appId, unifiedApi, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GetConnectorResourceResponse)</returns>
        public async System.Threading.Tasks.Task<Apideck.Client.ApiResponse<GetConnectorResourceResponse>> ConnectorResourcesOneWithHttpInfoAsync(string id, string resourceId, string appId = default(string), UnifiedApiId? unifiedApi = default(UnifiedApiId?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
