...
namespace Apideck.Api
{
    ...
    public interface IEcommerceApiSync : IApiAccessor
    {
        ...
        GetEcommerceOrdersResponse OrdersAll(bool? raw = default(bool?), string consumerId = default(string), string appId = default(string), string serviceId = default(string), string cursor = default(string), int? limit = default(int?), EcommerceOrdersFilter filter = default(EcommerceOrdersFilter), PassThroughQuery passThrough = default(PassThroughQuery), string fields = default(string));
    ...
    public interface IEcommerceApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<GetEcommerceOrdersResponse> OrdersAllAsync(bool? raw = default(bool?), string consumerId = default(string), string appId = default(string), string serviceId = default(string), string cursor = default(string), int? limit = default(int?), EcommerceOrdersFilter filter = default(EcommerceOrdersFilter), PassThroughQuery passThrough = default(PassThroughQuery), string fields = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
