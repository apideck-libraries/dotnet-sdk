...
namespace Apideck.Api
{
    ...
    public interface IVaultApiSync : IApiAccessor
    {
        ...
        /// <param name="serviceId">Service ID of the resource to return</param>
        /// <param name="unifiedApi">Unified API</param>
        /// <param name="createCallbackStateData">Callback state data</param>
        /// <param name="consumerId">ID of the consumer which you want to get or push data from (optional)</param>
        /// <param name="appId">The ID of your Unify application (optional)</param>
        /// <returns>CreateCallbackStateResponse</returns>
        CreateCallbackStateResponse CreateCallbackState(string serviceId, string unifiedApi, CreateCallbackStateData createCallbackStateData, string consumerId = default(string), string appId = default(string));
        ...
        ApiResponse<CreateCallbackStateResponse> CreateCallbackStateWithHttpInfo(string serviceId, string unifiedApi, CreateCallbackStateData createCallbackStateData, string consumerId = default(string), string appId = default(string));
        /// <summary>
    ...
    public interface IVaultApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<CreateCallbackStateResponse> CreateCallbackStateAsync(string serviceId, string unifiedApi, CreateCallbackStateData createCallbackStateData, string consumerId = default(string), string appId = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<CreateCallbackStateResponse>> CreateCallbackStateWithHttpInfoAsync(string serviceId, string unifiedApi, CreateCallbackStateData createCallbackStateData, string consumerId = default(string), string appId = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get resource custom fields
        /// </summary>
        /// <remarks>
    ...
    public partial class VaultApi : IVaultApi
    {
        ...
        /// <param name="appId">The ID of your Unify application (optional)</param>
        /// <returns>CreateCallbackStateResponse</returns>
        public CreateCallbackStateResponse CreateCallbackState(string serviceId, string unifiedApi, CreateCallbackStateData createCallbackStateData, string consumerId = default(string), string appId = default(string))
        {
            Apideck.Client.ApiResponse<CreateCallbackStateResponse> localVarResponse = CreateCallbackStateWithHttpInfo(serviceId, unifiedApi, createCallbackStateData, consumerId, appId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="appId">The ID of your Unify application (optional)</param>
        /// <returns>ApiResponse of CreateCallbackStateResponse</returns>
        public Apideck.Client.ApiResponse<CreateCallbackStateResponse> CreateCallbackStateWithHttpInfo(string serviceId, string unifiedApi, CreateCallbackStateData createCallbackStateData, string consumerId = default(string), string appId = default(string))
        {
            // verify the required parameter 'serviceId' is set
            if (serviceId == null)
            {
            ...
            // verify the required parameter 'createCallbackStateData' is set
            if (createCallbackStateData == null)
            {
                throw new Apideck.Client.ApiException(400, "Missing required parameter 'createCallbackStateData' when calling VaultApi->CreateCallbackState");
            }
            ...
            localVarRequestOptions.Data = createCallbackStateData;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of CreateCallbackStateResponse</returns>
        public async System.Threading.Tasks.Task<CreateCallbackStateResponse> CreateCallbackStateAsync(string serviceId, string unifiedApi, CreateCallbackStateData createCallbackStateData, string consumerId = default(string), string appId = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Apideck.Client.ApiResponse<CreateCallbackStateResponse> localVarResponse = await CreateCallbackStateWithHttpInfoAsync(serviceId, unifiedApi, createCallbackStateData, consumerId, appId, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
