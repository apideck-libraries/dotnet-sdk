...
namespace Apideck.Api
{
    ...
    public interface IAtsApiSync : IApiAccessor
    {
        ...
        GetApplicantsResponse ApplicantsAll(bool? raw = default(bool?), string consumerId = default(string), string appId = default(string), string serviceId = default(string), string cursor = default(string), int? limit = default(int?), ApplicantsFilter filter = default(ApplicantsFilter), PassThroughQuery passThrough = default(PassThroughQuery), string fields = default(string));
        ...
        GetApplicationsResponse ApplicationsAll(bool? raw = default(bool?), string consumerId = default(string), string appId = default(string), string serviceId = default(string), string cursor = default(string), PassThroughQuery passThrough = default(PassThroughQuery), int? limit = default(int?));
        ...
        ApiResponse<GetApplicationsResponse> ApplicationsAllWithHttpInfo(bool? raw = default(bool?), string consumerId = default(string), string appId = default(string), string serviceId = default(string), string cursor = default(string), PassThroughQuery passThrough = default(PassThroughQuery), int? limit = default(int?));
        /// <summary>
        /// Delete Application
        /// </summary>
        /// <remarks>
        ...
        GetJobsResponse JobsAll(bool? raw = default(bool?), string consumerId = default(string), string appId = default(string), string serviceId = default(string), string cursor = default(string), int? limit = default(int?), PassThroughQuery passThrough = default(PassThroughQuery), string fields = default(string));
        ...
        ApiResponse<GetJobsResponse> JobsAllWithHttpInfo(bool? raw = default(bool?), string consumerId = default(string), string appId = default(string), string serviceId = default(string), string cursor = default(string), int? limit = default(int?), PassThroughQuery passThrough = default(PassThroughQuery), string fields = default(string));
        /// <summary>
        /// Get Job
        /// </summary>
        /// <remarks>
    ...
    public interface IAtsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<GetApplicantsResponse> ApplicantsAllAsync(bool? raw = default(bool?), string consumerId = default(string), string appId = default(string), string serviceId = default(string), string cursor = default(string), int? limit = default(int?), ApplicantsFilter filter = default(ApplicantsFilter), PassThroughQuery passThrough = default(PassThroughQuery), string fields = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class AtsApi : IAtsApi
    {
        ...
        /// <param name="fields">The &#39;fields&#39; parameter allows API users to specify the fields they want to include in the API response. If this parameter is not present, the API will return all available fields. If this parameter is present, only the fields specified in the comma-separated string will be included in the response. Nested properties can also be requested by using a dot notation. &lt;br /&gt;&lt;br /&gt;Example: &#x60;fields&#x3D;name,email,addresses.city&#x60;&lt;br /&gt;&lt;br /&gt;In the example above, the response will only include the fields \&quot;name\&quot;, \&quot;email\&quot; and \&quot;addresses.city\&quot;. If any other fields are available, they will be excluded. (optional)</param>
        /// <returns>GetApplicantsResponse</returns>
        public GetApplicantsResponse ApplicantsAll(bool? raw = default(bool?), string consumerId = default(string), string appId = default(string), string serviceId = default(string), string cursor = default(string), int? limit = default(int?), ApplicantsFilter filter = default(ApplicantsFilter), PassThroughQuery passThrough = default(PassThroughQuery), string fields = default(string))
        {
            Apideck.Client.ApiResponse<GetApplicantsResponse> localVarResponse = ApplicantsAllWithHttpInfo(raw, consumerId, appId, serviceId, cursor, limit, filter, passThrough, fields);
            return localVarResponse.Data;
        }
        ...
        {
            Apideck.Client.ApiResponse<GetApplicantsResponse> localVarResponse = await ApplicantsAllWithHttpInfoAsync(raw, consumerId, appId, serviceId, cursor, limit, filter, passThrough, fields, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="limit">Number of results to return. Minimum 1, Maximum 200, Default 20 (optional, default to 20)</param>
        /// <returns>GetApplicationsResponse</returns>
        public GetApplicationsResponse ApplicationsAll(bool? raw = default(bool?), string consumerId = default(string), string appId = default(string), string serviceId = default(string), string cursor = default(string), PassThroughQuery passThrough = default(PassThroughQuery), int? limit = default(int?))
        {
            Apideck.Client.ApiResponse<GetApplicationsResponse> localVarResponse = ApplicationsAllWithHttpInfo(raw, consumerId, appId, serviceId, cursor, passThrough, limit);
            return localVarResponse.Data;
        }
        ...
        /// <param name="limit">Number of results to return. Minimum 1, Maximum 200, Default 20 (optional, default to 20)</param>
        /// <returns>ApiResponse of GetApplicationsResponse</returns>
        public Apideck.Client.ApiResponse<GetApplicationsResponse> ApplicationsAllWithHttpInfo(bool? raw = default(bool?), string consumerId = default(string), string appId = default(string), string serviceId = default(string), string cursor = default(string), PassThroughQuery passThrough = default(PassThroughQuery), int? limit = default(int?))
        {
            Apideck.Client.RequestOptions localVarRequestOptions = new Apideck.Client.RequestOptions();
        ...
        {
            Apideck.Client.ApiResponse<GetApplicationsResponse> localVarResponse = await ApplicationsAllWithHttpInfoAsync(raw, consumerId, appId, serviceId, cursor, passThrough, limit, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="fields">The &#39;fields&#39; parameter allows API users to specify the fields they want to include in the API response. If this parameter is not present, the API will return all available fields. If this parameter is present, only the fields specified in the comma-separated string will be included in the response. Nested properties can also be requested by using a dot notation. &lt;br /&gt;&lt;br /&gt;Example: &#x60;fields&#x3D;name,email,addresses.city&#x60;&lt;br /&gt;&lt;br /&gt;In the example above, the response will only include the fields \&quot;name\&quot;, \&quot;email\&quot; and \&quot;addresses.city\&quot;. If any other fields are available, they will be excluded. (optional)</param>
        /// <returns>GetJobsResponse</returns>
        public GetJobsResponse JobsAll(bool? raw = default(bool?), string consumerId = default(string), string appId = default(string), string serviceId = default(string), string cursor = default(string), int? limit = default(int?), PassThroughQuery passThrough = default(PassThroughQuery), string fields = default(string))
        {
            Apideck.Client.ApiResponse<GetJobsResponse> localVarResponse = JobsAllWithHttpInfo(raw, consumerId, appId, serviceId, cursor, limit, passThrough, fields);
            return localVarResponse.Data;
        }
        ...
        {
            Apideck.Client.ApiResponse<GetJobsResponse> localVarResponse = await JobsAllWithHttpInfoAsync(raw, consumerId, appId, serviceId, cursor, limit, passThrough, fields, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
